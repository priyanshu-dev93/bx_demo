...
exports.isExistingAgentInstance = isExistingAgentInstance;
...
class DevtoolsProxyAgentWithSystemCA extends agent_base_1.Agent {
    constructor(proxyOptions) {
        ...
        this.proxyOptions = proxyOptions;
        this.agent = (async () => {
            const { ca } = await (0, system_ca_1.systemCA)({
                ca: proxyOptions.ca,
...
function useOrCreateAgent(proxyOptions, target, useTargetRegardlessOfExistingAgent = false) {
    if (isExistingAgentInstance(proxyOptions)) {
        ...
        if (target !== undefined && !(0, proxy_options_1.proxyForUrl)(proxyOptions, target)) {
            return undefined;
        }
        return createAgent(proxyOptions);
    }
}
function isExistingAgentInstance(options) {
